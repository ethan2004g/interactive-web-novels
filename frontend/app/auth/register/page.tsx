              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  ...
                  <span className="ml-3 text-sm text-gray-700">
                    <span className="font-medium">Read stories</span>
                    <span className="block text-gray-500">Browse and read interactive novels</span>
                  </span>
                </label>
                <label className="flex items-center">
                  <input
                  ...
                  />
                  <span className="ml-3 text-sm text-gray-700">
                    <span className="font-medium">Write stories</span>
